...
const slides = [
  {
    image:
      "https://images.unsplash.com/photo-1540747913346-19e32dc3e97e?auto=format&fit=crop&w=1950&q=80",
    caption: "Feel the joy of the game",
  },
  {
    image:
      "https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=1950&q=80",
    caption: "Inspired by nature & strategy",
  },
  {
    image:
      "https://images.unsplash.com/photo-1521412644187-c49fa049e84d?auto=format&fit=crop&w=1950&q=80",
    caption: "Build teams. Create legacy.",
  },
  {
    image:
      "https://images.unsplash.com/photo-1508766206392-8bd5cf550d1b?auto=format&fit=crop&w=1950&q=80",
    caption: "A modern cricket experience",
  },
];
    ...
    <>
      ...
      <section className="relative min-h-screen overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-6 text-center">
          {/* Glass Card */}
          <div className="bg-white/80 backdrop-blur-md rounded-3xl px-10 py-12 shadow-xl max-w-3xl">
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-14 items-center">
          <div>
            <h2 className="text-4xl font-bold text-gray-900">
              A Fresh Take on Cricket Auctions
            </h2>
            <p className="mt-6 text-lg text-gray-700 leading-relaxed">
              Enthusiast Cricket Club blends strategy, community, and the love
              for the game into a modern auction experience. Designed for
              clarity, excitement, and joy — not clutter.
            </p>
          </div>

          <img
            src="https://images.unsplash.com/photo-1502877338535-766e1452684a?auto=format&fit=crop&w=1200&q=80"
            alt="Nature and sport"
